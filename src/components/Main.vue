<template>
    <div class="px-12 py-20 bg-black/60 text-gray-300">
      <div class="flex flex-col max-w-xl mx-auto">
        ...
        >
          ...
          <div class="grid grid-cols-2 gap-8 mb-8">
            <div v-for="item in workItems" :key="item.title" class="col-span-2 sm:col-span-1">
              <WorksCard 
                :item="item"
              />
            </div>
          ...
          <a href="#" class="h-8 w-20 p-2 border-2 rounded-lg">Check out my Github!</a>
        </section>
      </div>
    </div>
</template>
